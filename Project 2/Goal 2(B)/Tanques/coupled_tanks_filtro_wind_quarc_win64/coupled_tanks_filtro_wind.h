...
#ifndef RTW_HEADER_coupled_tanks_filtro_wind_h_
#define RTW_HEADER_coupled_tanks_filtro_wind_h_
#include <string.h>
#ifndef coupled_tanks_filtro_wind_COMMON_INCLUDES_
# define coupled_tanks_filtro_wind_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* coupled_tanks_filtro_wind_COMMON_INCLUDES_ */

#include "coupled_tanks_filtro_wind_types.h"
...
#define coupled_tanks_filtro_wind_rtModel RT_MODEL_coupled_tanks_filtro_T
...
} DW_coupled_tanks_filtro_wind_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T Integrator_CSTATE_p;          /* '<Root>/Integrator ' */
} X_coupled_tanks_filtro_wind_T;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T Integrator_CSTATE_p;          /* '<Root>/Integrator ' */
} XDot_coupled_tanks_filtro_win_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
  boolean_T Integrator_CSTATE_p;       /* '<Root>/Integrator ' */
} XDis_coupled_tanks_filtro_win_T;
...
#define rtB                            coupled_tanks_filtro_wind_B
#define BlockIO                        B_coupled_tanks_filtro_wind_T
#define rtX                            coupled_tanks_filtro_wind_X
#define ContinuousStates               X_coupled_tanks_filtro_wind_T
#define rtXdot                         coupled_tanks_filtro_wind_XDot
#define StateDerivatives               XDot_coupled_tanks_filtro_win_T
#define tXdis                          coupled_tanks_filtro_wind_XDis
#define StateDisabled                  XDis_coupled_tanks_filtro_win_T
#define rtP                            coupled_tanks_filtro_wind_P
#define Parameters                     P_coupled_tanks_filtro_wind_T
#define rtDWork                        coupled_tanks_filtro_wind_DW
#define D_Work                         DW_coupled_tanks_filtro_wind_T

/* Parameters (auto storage) */
struct P_coupled_tanks_filtro_wind_T_ {
  ...
  real_T Kp_Gain;                      /* Expression: 0.5
                                        ...
                                        */
  real_T Kd_Gain;                      /* Expression: 0.05
...
extern P_coupled_tanks_filtro_wind_T coupled_tanks_filtro_wind_P;

/* Block signals (auto storage) */
extern B_coupled_tanks_filtro_wind_T coupled_tanks_filtro_wind_B;

/* Continuous states (auto storage) */
extern X_coupled_tanks_filtro_wind_T coupled_tanks_filtro_wind_X;

/* Block states (auto storage) */
extern DW_coupled_tanks_filtro_wind_T coupled_tanks_filtro_wind_DW;

/* Model entry point functions */
extern void coupled_tanks_filtro_wind_initialize(void);
extern void coupled_tanks_filtro_wind_output(void);
extern void coupled_tanks_filtro_wind_update(void);
extern void coupled_tanks_filtro_wind_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern coupled_tanks_filtro_wind_rtModel *coupled_tanks_filtro_wind(void);
...
extern RT_MODEL_coupled_tanks_filtro_T *const coupled_tanks_filtro_wind_M;
 ...
 *
 * '<Root>' : 'coupled_tanks_filtro_wind'
 * '<S1>'   : 'coupled_tanks_filtro_wind/PLANTA'
 */
#endif                                 /* RTW_HEADER_coupled_tanks_filtro_wind_h_ */
