...
typedef struct {
  ...
  real_T Referencia;                   /* '<Root>/Constant' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Kp;                           /* '<Root>/Kp ' */
  real_T Ki;                           /* '<Root>/Ki  ' */
  real_T Kd;                           /* '<Root>/Kd ' */
  ...
  boolean_T Compare_b;                 /* '<S4>/Compare' */
} B_coupled_tanks_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Nivel12Referencia_PWORK;           /* '<Root>/Nivel 1//2//Referencia ' */

  struct {
    void *LoggedData;
  } Saturao_PWORK;                     /* '<Root>/Saturação' */
...
struct P_coupled_tanks_T_ {
  ...
  real_T HILInitialize_analog_output_min;/* Mask Parameter: HILInitialize_analog_output_min
                                          * Referenced by: '<S1>/HIL Initialize'
                                          */
  real_T LowlevelLL_const;             /* Mask Parameter: LowlevelLL_const
                                        * Referenced by: '<S8>/Constant'
                                        */
  real_T CompareToConstant1_const;     /* Mask Parameter: CompareToConstant1_const
                                        * Referenced by: '<S3>/Constant'
                                        */
  real_T HighLevel_const;              /* Mask Parameter: HighLevel_const
  ...
  real_T OPNormal_Value;               /* Expression: 3
                                        ...
                                        */
  real_T Tensaoquemantmnivel1prximode30c;/* Expression: 3
                                          * Referenced by: '<S2>/Tensao que mantém nivel 1 próximo de 30 cm'
                                          */
  real_T Desligaabomba0V_Value;        /* Expression: 0
                                        * Referenced by: '<S2>/Desliga a bomba(0V)'
                                        */
 ...
 * '<S3>'   : 'coupled_tanks/Subsystem/Compare To Constant1'
 * '<S4>'   : 'coupled_tanks/Subsystem/Compare To Constant2'
 * '<S5>'   : 'coupled_tanks/Subsystem/Compare To Constant3'
 * '<S6>'   : 'coupled_tanks/Subsystem/Compare To Constant4'
 * '<S7>'   : 'coupled_tanks/Subsystem/High Level'
 * '<S8>'   : 'coupled_tanks/Subsystem/Low level(LL)'
 */
