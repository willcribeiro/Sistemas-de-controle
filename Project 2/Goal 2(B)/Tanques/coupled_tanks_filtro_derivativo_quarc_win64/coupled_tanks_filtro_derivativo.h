/*
 * coupled_tanks_filtro_derivativo.h
 *
...
#ifndef RTW_HEADER_coupled_tanks_filtro_derivativo_h_
#define RTW_HEADER_coupled_tanks_filtro_derivativo_h_
#include <string.h>
#ifndef coupled_tanks_filtro_derivativo_COMMON_INCLUDES_
# define coupled_tanks_filtro_derivativo_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* coupled_tanks_filtro_derivativo_COMMON_INCLUDES_ */

#include "coupled_tanks_filtro_derivativo_types.h"
...
#define coupled_tanks_filtro_derivativo_rtModel RT_MODEL_coupled_tanks_filtro_T
...
} B_coupled_tanks_filtro_deriva_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Ganhos_PWORK;                      /* '<Root>/Ganhos' */

  struct {
    void *LoggedData;
  } Ganhos1_PWORK;                     /* '<Root>/Ganhos1' */

  struct {
    void *LoggedData;
  } NivelReferencia_PWORK;             /* '<Root>/Nivel//Referencia' */
...
} DW_coupled_tanks_filtro_deriv_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T Integrator_CSTATE_p;          /* '<Root>/Integrator ' */
} X_coupled_tanks_filtro_deriva_T;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T Integrator_CSTATE_p;          /* '<Root>/Integrator ' */
} XDot_coupled_tanks_filtro_der_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
  boolean_T Integrator_CSTATE_p;       /* '<Root>/Integrator ' */
} XDis_coupled_tanks_filtro_der_T;
...
#define rtB                            coupled_tanks_filtro_derivati_B
#define BlockIO                        B_coupled_tanks_filtro_deriva_T
#define rtX                            coupled_tanks_filtro_derivati_X
#define ContinuousStates               X_coupled_tanks_filtro_deriva_T
#define rtXdot                         coupled_tanks_filtro_deriv_XDot
#define StateDerivatives               XDot_coupled_tanks_filtro_der_T
#define tXdis                          coupled_tanks_filtro_deriv_XDis
#define StateDisabled                  XDis_coupled_tanks_filtro_der_T
#define rtP                            coupled_tanks_filtro_derivati_P
#define Parameters                     P_coupled_tanks_filtro_deriva_T
#define rtDWork                        coupled_tanks_filtro_derivat_DW
#define D_Work                         DW_coupled_tanks_filtro_deriv_T

/* Parameters (auto storage) */
struct P_coupled_tanks_filtro_deriva_T_ {
  ...
  real_T Kp_Gain;                      /* Expression: 0.5
                                        ...
                                        */
  real_T Kd_Gain;                      /* Expression: 0.15
  ...
  real_T Saturation_LowerSat;          /* Expression: -4
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Ki_Gain;                      /* Expression: 0.05
                                        * Referenced by: '<Root>/Ki  '
                                        */
  real_T Kaw_Gain;                     /* Expression: 0.03
...
struct tag_RTM_coupled_tanks_filtro__T {
  const char_T *path;
...
extern P_coupled_tanks_filtro_deriva_T coupled_tanks_filtro_derivati_P;

/* Block signals (auto storage) */
extern B_coupled_tanks_filtro_deriva_T coupled_tanks_filtro_derivati_B;

/* Continuous states (auto storage) */
extern X_coupled_tanks_filtro_deriva_T coupled_tanks_filtro_derivati_X;

/* Block states (auto storage) */
extern DW_coupled_tanks_filtro_deriv_T coupled_tanks_filtro_derivat_DW;

/* Model entry point functions */
extern void coupled_tanks_filtro_derivativo_initialize(void);
extern void coupled_tanks_filtro_derivativo_output(void);
extern void coupled_tanks_filtro_derivativo_update(void);
extern void coupled_tanks_filtro_derivativo_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern coupled_tanks_filtro_derivativo_rtModel *coupled_tanks_filtro_derivativo
  (void);
...
extern RT_MODEL_coupled_tanks_filtro_T *const coupled_tanks_filtro_derivat_M;
 ...
 *
 * '<Root>' : 'coupled_tanks_filtro_derivativo'
 * '<S1>'   : 'coupled_tanks_filtro_derivativo/PLANTA'
 */
#endif                                 /* RTW_HEADER_coupled_tanks_filtro_derivativo_h_ */
