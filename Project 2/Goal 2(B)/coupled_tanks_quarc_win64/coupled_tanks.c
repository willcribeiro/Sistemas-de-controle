 ...
 * C source code generated on : Fri Sep 06 15:57:21 2019
 *
...
void coupled_tanks_output(void)
{
   ...
   */
  coupled_tanks_B.Ki1 = coupled_tanks_P.Ki1_Gain *
  ...
  /* Sum: '<Root>/Add' */
  coupled_tanks_B.Add = (coupled_tanks_B.Kp + coupled_tanks_B.Ki1) +
    coupled_tanks_B.Kd1;
...
RT_MODEL_coupled_tanks_T *coupled_tanks(void)
{
  ...
  /* External mode info */
  coupled_tanks_M->Sizes.checksums[0] = (45789537U);
  coupled_tanks_M->Sizes.checksums[1] = (3125503404U);
  coupled_tanks_M->Sizes.checksums[2] = (2590562908U);
  coupled_tanks_M->Sizes.checksums[3] = (1127478546U);
  ...
  coupled_tanks_M->Sizes.numBlocks = (16);/* Number of blocks */
