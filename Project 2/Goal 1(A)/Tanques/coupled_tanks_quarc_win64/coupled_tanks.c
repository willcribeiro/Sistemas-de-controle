 ...
 * C source code generated on : Fri Sep 13 16:21:44 2019
 *
...
void coupled_tanks_output(void)
{
  ...
  if (rtmIsMajorTimeStep(coupled_tanks_M)) {
    ...
    /* Sum: '<Root>/Sum' */
    coupled_tanks_B.Sum = coupled_tanks_B.Constant -
  ...
  coupled_tanks_B.Integrator = coupled_tanks_X.Integrator_CSTATE;
  ...
  /* Gain: '<Root>/Kd 1' */
  coupled_tanks_B.Kd1 = coupled_tanks_P.Kd1_Gain * rtb_Derivative;

  /* Sum: '<Root>/Add' */
  coupled_tanks_B.Add = (coupled_tanks_B.Kp + coupled_tanks_B.Integrator) +
    coupled_tanks_B.Kd1;
  ...
  if (coupled_tanks_B.Add > coupled_tanks_P.Saturation_UpperSat) {
    ...
    coupled_tanks_B.Saturation = coupled_tanks_B.Add;
  }
  ...
  if (rtmIsMajorTimeStep(coupled_tanks_M)) {
    ...
    /* Gain: '<Root>/Ki  1' */
    coupled_tanks_B.Ki1 = coupled_tanks_P.Ki1_Gain * coupled_tanks_B.Sum;
  }
   ...
   *  Sum: '<Root>/Sum1'
   */
  coupled_tanks_B.Sum2 = (coupled_tanks_B.Saturation - coupled_tanks_B.Add) *
    coupled_tanks_P.Kaw_Gain + coupled_tanks_B.Ki1;
}
...
void coupled_tanks_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = coupled_tanks_B.Sum2;
}
...
RT_MODEL_coupled_tanks_T *coupled_tanks(void)
{
  ...
  rtmSetTFinal(coupled_tanks_M, 100.0);
  coupled_tanks_M->Timing.stepSize0 = 0.002;
  coupled_tanks_M->Timing.stepSize1 = 0.002;

  /* External mode info */
  coupled_tanks_M->Sizes.checksums[0] = (2670531774U);
  coupled_tanks_M->Sizes.checksums[1] = (3187919162U);
  coupled_tanks_M->Sizes.checksums[2] = (4270659470U);
  coupled_tanks_M->Sizes.checksums[3] = (2694316555U);
...

  {
    ...
    coupled_tanks_B.Integrator = 0.0;
    coupled_tanks_B.Kd1 = 0.0;
    coupled_tanks_B.Add = 0.0;
    coupled_tanks_B.Saturation = 0.0;
    coupled_tanks_B.Ki1 = 0.0;
    coupled_tanks_B.Sum2 = 0.0;
  }
  ...
  coupled_tanks_M->Sizes.numBlocks = (19);/* Number of blocks */
  coupled_tanks_M->Sizes.numBlockIO = (10);/* Number of block outputs */
  coupled_tanks_M->Sizes.numBlockPrms = (108);/* Sum of parameter "widths" */
