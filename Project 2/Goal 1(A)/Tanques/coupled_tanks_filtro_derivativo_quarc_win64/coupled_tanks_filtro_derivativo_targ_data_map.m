  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (coupled_tanks_filtro_derivati_P)
    ;%
      section.nData     = 17;
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_other_outputs
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 11;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_other_outpu_d
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 12;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_other_outpu_p
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 13;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_other_outpu_f
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_hardware_clocks
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_watchdog_digital_
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_analog_input_chan
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILReadAnalog_channels
	  section.data(3).logicalSrcIdx = 26;
	  section.data(3).dtTransOffset = 16;
	
	  ;% coupled_tanks_filtro_derivati_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 27;
	  section.data(4).dtTransOffset = 18;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_encoder_channels
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 31;
	  section.data(1).dtTransOffset = 0;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 32;
	  section.data(2).dtTransOffset = 1;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 33;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_analog_input_
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_analog_output
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_analog_outp_h
	  section.data(11).logicalSrcIdx = 41;
	  section.data(11).dtTransOffset = 10;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_analog_out_bm
	  section.data(12).logicalSrcIdx = 42;
	  section.data(12).dtTransOffset = 11;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 43;
	  section.data(13).dtTransOffset = 12;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_clock_frequ_i
	  section.data(14).logicalSrcIdx = 44;
	  section.data(14).dtTransOffset = 13;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 45;
	  section.data(15).dtTransOffset = 14;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_clock_param_n
	  section.data(16).logicalSrcIdx = 46;
	  section.data(16).dtTransOffset = 15;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 47;
	  section.data(17).dtTransOffset = 16;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_out_l
	  section.data(18).logicalSrcIdx = 48;
	  section.data(18).dtTransOffset = 17;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_out_k
	  section.data(19).logicalSrcIdx = 49;
	  section.data(19).dtTransOffset = 18;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_out_o
	  section.data(20).logicalSrcIdx = 50;
	  section.data(20).dtTransOffset = 19;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_out_j
	  section.data(21).logicalSrcIdx = 51;
	  section.data(21).dtTransOffset = 20;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_ou_ol
	  section.data(22).logicalSrcIdx = 52;
	  section.data(22).dtTransOffset = 21;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_digital_out_i
	  section.data(23).logicalSrcIdx = 53;
	  section.data(23).dtTransOffset = 22;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_encoder_count
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_encoder_param
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_other_outpu_a
	  section.data(28).logicalSrcIdx = 58;
	  section.data(28).dtTransOffset = 27;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_pwm_outputs_b
	  section.data(32).logicalSrcIdx = 62;
	  section.data(32).dtTransOffset = 31;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 63;
	  section.data(33).dtTransOffset = 32;
	
	  ;% coupled_tanks_filtro_derivati_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% coupled_tanks_filtro_derivati_P.VoltstocmTank1_Gain
	  ...
	  ;% coupled_tanks_filtro_derivati_P.Kp_Gain
	  section.data(3).logicalSrcIdx = 68;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_filtro_derivati_P.Kd_Gain
	  ...
	  ;% coupled_tanks_filtro_derivati_P.Ki_Gain
	  ...
	  ;% coupled_tanks_filtro_derivati_P.HILReadAnalog_Active
	  section.data(1).logicalSrcIdx = 76;
	  section.data(1).dtTransOffset = 0;
	
	  ;% coupled_tanks_filtro_derivati_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (coupled_tanks_filtro_derivati_B)
    ;%
      section.nData     = 10;
      section.data(10)  = dumData; %prealloc
	  ...
	  ;% coupled_tanks_filtro_derivati_B.Kp
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (coupled_tanks_filtro_derivat_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.HILReadAnalog_Buffer
	  section.data(9).logicalSrcIdx = 8;
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.LastUAtTimeA
	  section.data(11).logicalSrcIdx = 10;
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.LastUAtTimeB
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.HILReadAnalog_PWORK
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILWriteAnalog_PWORK
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% coupled_tanks_filtro_derivat_DW.Ganhos_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% coupled_tanks_filtro_derivat_DW.Ganhos1_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% coupled_tanks_filtro_derivat_DW.NivelReferencia_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 4;
	
	  ;% coupled_tanks_filtro_derivat_DW.Sat_PWORK.LoggedData
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 20;
	  section.data(1).dtTransOffset = 0;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 21;
	  section.data(2).dtTransOffset = 3;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 22;
	  section.data(3).dtTransOffset = 11;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 23;
	  section.data(4).dtTransOffset = 19;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 24;
	  section.data(5).dtTransOffset = 27;
	
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_POPolarityVals
	  ...
	  ;% coupled_tanks_filtro_derivat_DW.HILInitialize_POSortedChans
  ...
  targMap.checksum0 = 1983567428;
  targMap.checksum1 = 2667853829;
  targMap.checksum2 = 130250874;
  targMap.checksum3 = 3570107119;
